...
"mlf", {
    ...
    "1. ക്രോണിക്കലുകൾ", "2. ക്രോണിക്കലുകൾ", 
    "എസ്ര", "നേഹെമ്യ", "എസ്റ്റർ", "യോബ്", "സങ്കീർത്തനങ്ങൾ", 
    "സൂത്രവാക്യങ്ങൾ", "പ്രാസംഗികം", "വ്യഥാസംഹിത", "ഇശയ", "യിരെമ്യ", 
...
},
{
    "mg", {
        ...
        "Ohabolana", "Mpanao fanompoam-pivavahana", "Hira lehibe", "Isaia", "Jeremia", 
...
{
    "sr", {
        "Postanje", "Izlazak", "Levitski zakonik", "Brojevi", "Ponovljeni zakon", 
        "Isus Navin", "Suci", "Ruta", "Prva knjiga Samuilova", "Druga knjiga Samuilova", 
        "Prva knjiga o kraljevima", "Druga knjiga o kraljevima", "Prva knjiga Dnevnika", "Druga knjiga Dnevnika", 
        "Ezra", "Nehemija", "Estera", "Jov", "Psaltir", 
        "Poslovice", "Propovednik", "Pesma nad pesmama", "Isaija", 
        "Jeremija", "Plač Jeremijin", "Ezekiel", "Daniel", 
        "Oseja", "Joel", "Amos", "Obadija", "Jona", 
        "Mihej", "Nahum", "Habakuk", "Sefanija", "Aggej", 
        "Zaharija", "Malakija", "Matej", "Marko", "Luka", 
        "Jovan", "Dela apostolska", "Rimljanima", "Prva poslanica Korinćanima", 
        "Druga poslanica Korinćanima", "Galaćanima", "Efescima", "Filipljanima", 
        "Kolosanima", "Prva poslanica Solunjanima", "Druga poslanica Solunjanima", "Prva poslanica Timoteju", 
        "Druga poslanica Timoteju", "Titu", "Filemonu", "Hebrejima", 
        "Jakov", "Prva poslanica Petru", "Druga poslanica Petru", "Prva poslanica Jovanova", 
        "Druga poslanica Jovanova", "Treća poslanica Jovanova", "Juda", "Otkrivenje"
    }
},
{
    "sv", {
