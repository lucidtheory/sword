...
pkglibexecdir = $(libexecdir)/sword
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = arm-apple-darwin23.5.0
host_triplet = arm-apple-darwin23.5.0
target_triplet = arm-apple-darwin23.5.0
noinst_PROGRAMS = buildtest$(EXEEXT)
subdir = .
...
am__depfiles_remade = ./$(DEPDIR)/buildtest.Po
am__mv = mv -f
...
am__v_CXXLD_1 = 
SOURCES = $(buildtest_SOURCES)
DIST_SOURCES = $(buildtest_SOURCES)
...
am__installdirs = "$(DESTDIR)$(pkgconfigdir)" \
	"$(DESTDIR)$(sysconfdir)"
DATA = $(pkgconfig_DATA) $(sysconf_DATA)
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = lib . tests utilities examples
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/doc/Makefile.am \
	$(srcdir)/locales.d/Makefile.am $(srcdir)/samples/Makefile.am \
	$(srcdir)/sword.pc.in $(srcdir)/sword.spec.in \
	$(top_srcdir)/include/config.h.in \
	$(top_srcdir)/include/swversion.h.in AUTHORS COPYING ChangeLog \
...
ACLOCAL = ${SHELL} /Users/art/Desktop/sword/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_CFLAGS = -g3 -O0 -Wall -fPIC -DEXCLUDEBZIP2 -DEXCLUDEXZ -DCURLAVAILABLE 
AM_CXXFLAGS = -g3 -O0 -Wall -Woverloaded-virtual -fPIC -DEXCLUDEBZIP2 -DEXCLUDEXZ -DCURLAVAILABLE  -DUSECXX11TIME -std=c++11  -Wno-address -Wno-nonnull-compare
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/art/Desktop/sword/missing autoconf
AUTOHEADER = ${SHELL} /Users/art/Desktop/sword/missing autoheader
AUTOMAKE = ${SHELL} /Users/art/Desktop/sword/missing automake-1.16
AWK = awk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /Users/art/Desktop/sword/missing makeinfo
MANIFEST_TOOL = :
...
SHELL = /bin/sh
STRIP = strip
SWORD_VERSION_MAJOR = 1
SWORD_VERSION_MICRO = 0
SWORD_VERSION_MINOR = 9
SWORD_VERSION_NANO = 0
SWORD_VERSION_NUM = 109000000
SWORD_VERSION_STR = 1.9.0
VERSION = 1.9.0
abs_builddir = /Users/art/Desktop/sword
abs_srcdir = /Users/art/Desktop/sword
abs_top_builddir = /Users/art/Desktop/sword
abs_top_srcdir = /Users/art/Desktop/sword
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/art/Desktop/sword/install-sh
...
EXTRA_DIST = sword.spec sword.kdevprj sword.bmp usrinst.sh autogen.sh \
	sword.pc.in $(localeDATA) samples/mods.d/globals.conf \
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am $(srcdir)/locales.d/Makefile.am $(srcdir)/samples/Makefile.am $(srcdir)/doc/Makefile.am $(am__configure_deps)
	@for dep in $?; do \
...
$(srcdir)/locales.d/Makefile.am $(srcdir)/samples/Makefile.am $(srcdir)/doc/Makefile.am $(am__empty):
...
sword.pc: $(top_builddir)/config.status $(srcdir)/sword.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
include/swversion.h: $(top_builddir)/config.status $(top_srcdir)/include/swversion.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
sword.spec: $(top_builddir)/config.status $(srcdir)/sword.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
buildtest$(EXEEXT): $(buildtest_OBJECTS) $(buildtest_DEPENDENCIES) $(EXTRA_buildtest_DEPENDENCIES) 
	@rm -f buildtest$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(buildtest_OBJECTS) $(buildtest_LDADD) $(LIBS)
...
include ./$(DEPDIR)/buildtest.Po # am--include-marker
...
installdirs-am:
	for dir in "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(sysconfdir)"; do \
...
register:
	@echo ""
	echo "(***) $$USER@$$HOSTNAME, $$(date), $$(uname -m -r -s), SWORD 1.9.0, ${pkgdatadir}" | mail sword.users@crosswire.org
	@echo ""
